					...
					<div class="footer_list_wrapper">
						...
						<ul>
							...
							<?php if (!Yii::$app->user->isGuest && Yii::$app->user->can('admin')) { ?>
								...
								<li><?= Html::a('View Schedule', ['/schedule/view']) ?></li>
								<li><?= Html::a('Manage Schedule', ['/schedule/index']) ?></li>
								...
								<li><?= Html::a('Manage Order', ['/orders/index']) ?></li>
							<?php } ?>

							<?php if (!Yii::$app->user->isGuest && Yii::$app->user->can('staff')) { ?>
								<li><?= Html::a('Profile', ['/user/view', 'id' => Yii::$app->user->id]) ?></li>
								<li><?= Html::a('View Schedule', ['/staff/schedule']) ?></li>
								<li><?= Html::a('Manage Schedule', ['/staff/view-schedule']) ?></li>
